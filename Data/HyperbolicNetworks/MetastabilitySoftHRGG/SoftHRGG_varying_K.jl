...
if test
    ...
    γ_tests = collect(2.01:0.04:2.99)
end
...
for γ in γ_tests
    ...
    for T in T_arr
        ...
        σ = repeat([1], N)
        varying_K = [0.01, 0.1, 1, 4, 7, 15, 20, 50]
        if test
            job_ID = 4
        else
        ...
        filepath = "/mnt/lustre/scratch/inf/ec627/data/HyperbolicNetworks/MetaVarK/"

        folders = ["K001/", "K01/", "K1/", "K4/", "K7/", "K15/", "K20/", "K50/"]
        ...
        filename = filepath * folders[job_ID] *  fileseed * file_node * file_avg_degree * filecoupling * file_τ_global * file_γ * file_temp_ * ".jld2"
