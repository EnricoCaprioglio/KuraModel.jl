...
# set folder path
folderpath = "/mnt/lustre/scratch/inf/ec627/data/HierarchicalChimera/paper_data/DataCollect/n1608Var_k_H/"
...
for k in k_range
    for H in H_range
        ...
        # save results
        results = [KOP_whole_mean, KOP_whole_std, KOP_pop_1_mean, KOP_pop_1_std, KOP_pop_2_mean, KOP_pop_2_std, KOP_modules_mean, KOP_modules_std, params]
